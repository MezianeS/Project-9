 ...
 = () => {
  return (
    <div className='agency__container--cartebis'>
        <div className='text-[black] flex flex-col justify-items-center'>
          <div className='font-semibold text-center'>Find our agency in Paris:</div>
            <div className='justify-items-center text-center mb-6 italic	'>
              7 Av. du General Lemmonier
              <br />
              75001, Paris
              <br />
              Contact us: +852 756 123 898
            </div>
