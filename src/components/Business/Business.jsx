  ...
  return (
    <div className='business__container bg-[black] pb-24'>
        <div className="business__container--block mx-auto max-w-[1240px] items-center p-6'">
            ...
            <div className="business__container--textimg flex flex-col lg:flex-row items-center">
                <p className="business__container--textblock mt-10 m-3 lg:ml-48 lg:mr-28 p-10 lg:pl-0 text-center lg:text-start text-lg">
