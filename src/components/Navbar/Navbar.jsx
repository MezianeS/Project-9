  ...
  return (
    <div className='navbar__projectnine text-lg'>
        <div className='container flex'>
            ...
            <ul className={nav ? 'fixed left-0 top-0 w-[60%] border-r border-r-gray-900 h-full bg-[#133C55] ease-in-out duration-500 max-[360px]:w-[70%]' : 'h-full ease-in-out duration-500 fixed left-[-100%]'}>
